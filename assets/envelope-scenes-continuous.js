import {isEnvelope, prepareEnvelope, drawEnvelope, EnvelopeScene} from './envelope-art-continuous.js';
...
export function keepCopperDetails(art) {
  ...
  // Transfer only the photographed copper pigment. Copying rectangular paper
  // strips would leave texture seams; copying the centre would leave a wax shadow.
